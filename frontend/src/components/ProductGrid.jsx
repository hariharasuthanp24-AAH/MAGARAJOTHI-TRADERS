  ...
  return (
    <section id="products-section" className="py-20 md:py-28 bg-[#FAF6F0] relative font-sans border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Scaled Up Filters & Search Bar */}
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-200 mb-12 flex flex-col lg:flex-row items-center justify-between gap-5">
          
          {/* Robust Category Filter Buttons */}
          ...
          <div className="relative w-full lg:w-80">
            ...
            <input
              ...
              className="w-full bg-[#FAF6F0] border border-gray-300 rounded-xl pl-12 pr-5 py-3.5 text-base text-gray-900 focus:outline-none focus:ring-2 focus:ring-jute-dark focus:bg-white transition"
            />
          </div>
        ...
        {loading ? (
          <div className="py-24 text-center flex flex-col items-center justify-center space-y-4">
            <Loader2 className="w-12 h-12 text-jute-dark animate-spin" />
            <p className="text-base font-semibold text-gray-700">Loading catalog items...</p>
          </div>
          ...
          /* Scaled Up Empty Search Fallback */
          <div className="bg-white p-16 rounded-3xl text-center border border-gray-200 max-w-xl mx-auto space-y-5 shadow-sm">
            ...
            <button
              ...
              className="bg-jute-dark text-white hover:bg-jute px-7 py-3 rounded-xl text-base font-semibold uppercase tracking-wider transition-colors shadow"
            >
              Reset All Filters
            </button>
          </div>
