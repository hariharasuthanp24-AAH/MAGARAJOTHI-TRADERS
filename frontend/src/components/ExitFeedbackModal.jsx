...
import { Star, X, CheckCircle2, Send, HeartHandshake } from 'lucide-react';
        ...
        {submitted ? (
          ...
          <div className="py-8 text-center space-y-4 animate-in zoom-in-95 duration-200">
            ...
            <p className="text-sm text-gray-600 max-w-xs mx-auto">
              Your response helps Magarajothi Traders deliver better eco-packaging services.
            </p>
          </div>
        ) : (
          /* Main Feedback Form */
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                Help us improve Magarajothi Traders. How was your browsing experience today?
              </p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell us how we can serve you better or what products you were looking for..."
